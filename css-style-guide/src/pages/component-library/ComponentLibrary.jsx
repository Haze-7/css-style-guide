//imports
import ComponentEntryDisplay from "../../components/ComponentEntryDisplay";
          ...
          <div className="bg-dark text-white w-full flex flex-col justify-between">
            ...
            <section className="bg-gold h-[200rem] w-full  ">
              ...
              {/*Infinite  Horizontal Scroll Animation */}
                <div className="relative pt-[8%] w-[80%] mx-auto overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-200px),transparent_100%)]"> 
