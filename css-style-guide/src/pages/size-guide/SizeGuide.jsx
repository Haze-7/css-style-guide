                ...
                <section className="bg-[#F3F0E8] h-[200rem] w-screen  ">
                    <div className="flex flex-col justify-center items-center relative top-[8%] ">
                        ...
                        <div className=" relative top-[8%] h-min-screen w-full">
                            {/* Title Header */}
                                <h1 className="text-8xl font-tungsten text-cinnamon flex justify-center pt-24">Try these Units</h1>

                            {/* Right side px bar */}
                            <div ref={pxRef} className={`absolute bg-gray w-[40%] h-[20rem] top-[28rem] right-0 rounded-2xl border-10 border-gold slide-animate-right ${pxIsVisible ? 'show' : ''}`}
                                >
                            ...
                            {/* Left side % bar */}
                            <div ref={percentRef} className={`absolute bg-gray w-[40%] h-[20rem] top-[50rem] left-0  rounded-2xl border-10 border-gold slide-animate-left ${percentIsVisible ? 'show' : ''}`}>
                            ...
                            {/* Right side Rem bar */}
                            <div ref={remRef} className={`absolute bg-gray w-[40%] h-[20rem] top-[71rem] right-0  rounded-2xl border-10 border-gold slide-animate-right ${remIsVisible ? 'show' : ''}`}>
                            ...
                            {/* Left side View bar */}
                            <div ref={viewRef} className={`absolute bg-gray w-[40%] h-[20rem] top-[93rem] left-0  rounded-2xl border-10 border-gold slide-animate-left ${viewIsVisible ? 'show' : ''}`}>
